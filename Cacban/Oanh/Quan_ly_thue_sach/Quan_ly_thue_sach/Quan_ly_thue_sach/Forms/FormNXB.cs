...
namespace Quan_ly_thue_sach.Forms
{
    public partial class frmNXB : Form
    {
        ...
        private void load_datagrid()
        {
            ...
            //viết code để lấy dữ liệu từ tblXuong lên datagridview
    ...
    protected override void WndProc(ref Message m)
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            //insert vao csdl
            sql = "insert into tblNXB(Manxb,Tennxb,Diachi,Dienthoai) values(N'" + txtManxb.Text.Trim() + "',N'" + txtTennxb.Text.Trim() + "',N'" + txtDiachi.Text.Trim() + "',N'" + txtDienthoai.Text.Trim() + "')";
        ...
        private void dataGridNXB_Click(object sender, EventArgs e)
        {
            ...
            txtDienthoai.Text = dataGridNXB.CurrentRow.Cells["Dienthoai"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
            btnBoqua.Enabled = true;
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string sql;
            sql = "update tblNXB set Tennxb=N'" + txtTennxb.Text.Trim() + "'where Manxb=N'" + txtManxb.Text.Trim() + "'";
            Classes.Funtions.RunSQL(sql);
            load_datagrid();
            resetvalue();
            btnBoqua.Enabled = false;
