...
namespace Quan_ly_thue_sach.Classes
{
    class Funtions
    {
        ...
        {
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\User\OneDrive\Desktop\Quan_ly_thue_sach\Quan_ly_thue_sach\Database\QL_ThueSach.mdf;Integrated Security=True;Connect Timeout=30";
