...
namespace Quan_ly_thue_sach.Classes
{
    class Funtions
    {
        ...
        {
            connString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\admin\Desktop\Slidemonhoc\CSLT2\BTLbandu\Quan_ly_thue_sach\Database\QL_ThueSach.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static void RunDelSQL(string SQL)
        {
            ...
            catch (System.Exception del)
            {
                MessageBox.Show("Du lieu dang dung boi chuong" +
                    " trinh khac, khong the xoa" + "\t\n \t\n Ma loi chi tiet: " + del.ToString());
            }
            cmd.Dispose();
            cmd = null;
        }
